        ...
        <div class="row mb-4">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary text-white mb-4">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="{{ route('reportes.productos.inventario') }}">Ver más</a>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-warning text-dark mb-4">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-dark stretched-link" href="{{ route('reportes.productos.mas_vendidos') }}">Ver más</a>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-info text-white mb-4">
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="{{ route('reportes.productos.bajo_stock') }}">Ver más</a>
                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card bg-success text-white mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <?php
                                    ...
                                    $historialProductos = Producto::count(); // O usa una consulta más específica
                                ?>
                    ...
                    <div class="card-footer d-flex align-items-center justify-content-between">
                        <a class="small text-white stretched-link" href="{{ route('reportes.productos.historial', ['id' => 'all']) }}">Ver más</a>
                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                    </div>
                </div>
            </div>
