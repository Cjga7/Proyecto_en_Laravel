                ...
                <div class="row g-3">
                    ...
                    <div id="box-razon-social" class="col-md-12 mb-2">
                        ...
                        <div id="razon-social-fields">
                            <input type="text" name="razones_sociales[]" id="razon_social" class="form-control mb-2"
...
@push('js')
    <script>
        ...
        $('#add-razon-social').on('click', function() {
            $('#razon-social-fields').append(
                '<input type="text" name="razones_sociales[]" class="form-control mb-2" placeholder="Razón Social">'
            );
        });
    </script>
@endpush
